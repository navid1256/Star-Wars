...
const INTRO_STORAGE_KEY = 'sw-chrono-intro-v3';
      ...
      {introComplete && (
        <>
          ...
          <main className="relative z-10 flex-1">
            ...
            <WhyThisOrderSection sortMode={sortMode} />
            <BeginnerSection />
...
function WhyThisOrderSection({ sortMode }: { sortMode: SortMode }) {
  const descriptions: Record<SortMode, string> = {
    chronological: `Watching Star Wars in chronological story order lets you experience the saga as one
    ...
    release: `Watching Star Wars in release order lets you experience the saga the way audiences
